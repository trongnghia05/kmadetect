...
def androcg_main(verbose,
    ...
    from kmadetect.androguard.misc import AnalyzeAPK
...
def export_apps_to_format(filename,
                          ...
                          form=None):
    from kmadetect.androguard.misc import clean_file_name
...
def androlyze_main(session, filename):
    ...
    from kmadetect.androguard.misc import init_print_colors
